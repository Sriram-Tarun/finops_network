...
def get_vdoms():
    ...
    try:
        ...
        frappe.log_error(str(e)[:200], "FortiGate DFC32 Address Get VDOMs Error")
...
def create_address(docname):
    doc = frappe.get_doc("DFC 3-2 Address", docname)
    ...
    try:
        ...
        frappe.log_error(str(e)[:200], "Fortigate DFC32 Address Create Error")
        return {"status": "error", "message": str(e)}
...
def update_address(docname):
    ...
    try:
        ...
        frappe.log_error(str(e)[:200], "Fortigate DFC32 Address Update Error")
        return {"status": "error", "message": str(e)}
    ...
    try:
        ...
        for vdom in vdom_list:
            ...
            try:
                ...
                frappe.log_error(str(e)[:200], f"DFC32 Address Sync Error - VDOM: {vdom}")
                continue
            ...
            for addr in data.get("results", []):
                ...
                if existing:
                    doc = frappe.get_doc("DFC 3-2 Address", existing)
                    ...
                    try:
                        ...
                        frappe.log_error(str(e)[:200], f"DFC32 Address Insert Error: {name}")
                        skipped += 1
        ...
        frappe.log_error(str(e)[:200], "FortiGate DFC32 Address Sync Error")
        return {"status": "error", "message": str(e)}
